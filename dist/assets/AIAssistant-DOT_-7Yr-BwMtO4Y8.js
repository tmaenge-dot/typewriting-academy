import{_ as l,m as e,v as s,S as r,A as f,k as O,N as x,E as w,F as S,B as P,G as E,j as T,a as D,$ as M,V as b,X as U,c as I,L,H as G,e as p,u as d,K as H,f as u,g as m,O as F,Q as B,p as q}from"./index-CciW6Xh8.js";const z=()=>{const[R,h]=l.useState([{id:"1",content:"Hello! I'm your Information Processing & Typewriting AI Assistant. I can help you with questions about computer care, typing techniques, business document formatting, and all aspects of the National Certificate in Secretarial Studies curriculum. What would you like to know?",role:"assistant",timestamp:new Date,category:"welcome"}]),[o,i]=l.useState(""),[c,y]=l.useState(!1),j={computerCare:{keywords:["computer care","handle computer","clean computer","maintain computer","computer safety"],answer:`COMPUTER CARE GUIDELINES:
...
I'm here to help with your Information Processing and Typewriting studies!`,role:"assistant",timestamp:new Date,category:"General Help"}},g=async()=>{if(!o.trim())return;const t={id:Date.now().toString(),content:o,role:"user",timestamp:new Date};h(n=>[...n,t]),i(""),y(!0),setTimeout(()=>{const n=v(o);h(a=>[...a,n]),y(!1)},1500)},k=t=>{i(t)},C=t=>{t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),g())};return e.jsxs(s,{sx:{width:"100%"},children:[e.jsxs(s,{mb:3,children:[e.jsx(r,{variant:"h4",component:"h1",gutterBottom:!0,sx:{fontSize:{xs:"1.5rem",md:"2rem"}},children:"🤖 AI Learning Assistant"}),e.jsx(r,{variant:"body1",color:"text.secondary",sx:{fontSize:{xs:"0.9rem",md:"1rem"}},children:"Get instant help with Information Processing & Typewriting questions"})]}),e.jsxs(s,{display:"flex",gap:2,height:"calc(100vh - 200px)",flexDirection:{xs:"column",md:"row"},children:[e.jsxs(f,{elevation:2,sx:{flex:2,display:"flex",flexDirection:"column",minHeight:{xs:"400px",md:"auto"}},children:[e.jsx(s,{sx:{flex:1,overflow:"auto",p:{xs:1.5,md:2}},children:e.jsxs(O,{children:[R.map(t=>e.jsxs(x,{sx:{alignItems:"flex-start",mb:1.5,px:0},children:[e.jsx(w,{children:e.jsx(S,{sx:{bgcolor:t.role==="user"?"primary.main":"secondary.main",width:{xs:32,md:40},height:{xs:32,md:40}},children:t.role==="user"?e.jsx(P,{sx:{fontSize:{xs:16,md:20}}}):e.jsx(E,{sx:{fontSize:{xs:16,md:20}}})})}),e.jsx(T,{primary:e.jsxs(s,{display:"flex",alignItems:"center",gap:1,mb:1,children:[e.jsx(r,{variant:"subtitle2",sx:{fontSize:{xs:"0.85rem",md:"0.95rem"}},children:t.role==="user"?"You":"AI Assistant"}),t.category&&e.jsx(D,{label:t.category,size:"small",variant:"outlined",color:"primary"}),e.jsx(r,{variant:"caption",color:"text.secondary",children:t.timestamp.toLocaleTimeString()})]}),secondary:e.jsx(r,{variant:"body2",sx:{whiteSpace:"pre-line",fontFamily:t.role==="assistant"?"monospace":"inherit",fontSize:t.role==="assistant"?"13px":"inherit"},children:t.content})})]},t.id)),c&&e.jsxs(x,{children:[e.jsx(w,{children:e.jsx(S,{sx:{bgcolor:"secondary.main"},children:e.jsx(E,{})})}),e.jsx(T,{primary:"AI Assistant is thinking...",secondary:e.jsx(M,{size:20})})]})]})}),e.jsx(b,{}),e.jsx(s,{sx:{p:2},children:e.jsxs(s,{display:"flex",gap:2,children:[e.jsx(U,{fullWidth:!0,multiline:!0,maxRows:3,value:o,onChange:t=>i(t.target.value),onKeyPress:C,placeholder:"Ask me anything about Information Processing & Typewriting...",variant:"outlined",disabled:c}),e.jsx(I,{variant:"contained",onClick:g,disabled:!o.trim()||c,sx:{minWidth:"auto",px:3},children:e.jsx(L,{})})]})})]}),e.jsx(s,{sx:{flex:1},children:e.jsxs(f,{sx:{p:3,height:"100%",overflow:"auto"},children:[e.jsx(r,{variant:"h6",gutterBottom:!0,children:"📚 Quick Questions"}),e.jsx(r,{variant:"body2",color:"text.secondary",mb:3,children:"Click on any question to ask the AI assistant:"}),A.map((t,n)=>e.jsxs(I,{variant:"outlined",fullWidth:!0,sx:{mb:1,textAlign:"left",justifyContent:"flex-start"},onClick:()=>k(t),children:[e.jsx(G,{sx:{mr:1,fontSize:16}}),t]},n)),e.jsx(b,{sx:{my:3}}),e.jsx(r,{variant:"h6",gutterBottom:!0,children:"🎯 Topic Categories"}),e.jsxs(p,{children:[e.jsxs(d,{expandIcon:e.jsx(u,{}),children:[e.jsx(H,{sx:{mr:1}}),e.jsx(r,{children:"Computer Operations"})]}),e.jsx(m,{children:e.jsxs(r,{variant:"body2",children:["• System startup and shutdown",e.jsx("br",{}),"• Hardware and software usage",e.jsx("br",{}),"• File management and storage",e.jsx("br",{}),"• Printer setup and operation",e.jsx("br",{}),"• Troubleshooting and maintenance"]})})]}),e.jsxs(p,{children:[e.jsxs(d,{expandIcon:e.jsx(u,{}),children:[e.jsx(F,{sx:{mr:1}}),e.jsx(r,{children:"Typing & Speed Development"})]}),e.jsx(m,{children:e.jsxs(r,{variant:"body2",children:["• Home row finger placement",e.jsx("br",{}),"• Proper typing technique",e.jsx("br",{}),"• Speed building exercises",e.jsx("br",{}),"• Accuracy improvement",e.jsx("br",{}),"• Common typing mistakes"]})})]}),e.jsxs(p,{children:[e.jsxs(d,{expandIcon:e.jsx(u,{}),children:[e.jsx(B,{sx:{mr:1}}),e.jsx(r,{children:"Business Documents"})]}),e.jsx(m,{children:e.jsxs(r,{variant:"body2",children:["• Business letter formatting",e.jsx("br",{}),"• Memorandum structure",e.jsx("br",{}),"• Report and invoice creation",e.jsx("br",{}),"• Professional presentation",e.jsx("br",{}),"• Document templates and standards"]})})]}),e.jsx(q,{severity:"info",sx:{mt:3},children:e.jsxs(r,{variant:"body2",children:["💡 ",e.jsx("strong",{children:"Tip:"}),' Be specific in your questions for better answers. For example: "How do I format the date in a business letter?" rather than "How do I write letters?"']})})]})})]})]})};export{z as default};
